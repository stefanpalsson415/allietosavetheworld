...
- Name: 🔥 CRITICAL: Chore & Reward Complete Lifecycle >> 👶 Assign chore to child
- Location: /Users/stefanpalsson/parentload copy/parentload-clean/tests/e2e/complete-lifecycle/14-chore-reward-lifecycle.spec.js:261:3
...
Call log:
  - navigating to "http://localhost:3000/dashboard?tab=chore-admin", waiting until "load"
    ...
    at /Users/stefanpalsson/parentload copy/parentload-clean/tests/e2e/complete-lifecycle/14-chore-reward-lifecycle.spec.js:265:16
```
