...
- Name: 📊 CRITICAL: Weekly Check-ins & Progress Tracking >> 📋 Weekly balance check-in survey completion
- Location: /Users/stefanpalsson/parentload copy/parentload-clean/tests/e2e/complete-lifecycle/12-weekly-checkins.spec.js:40:3
...
Call log:
  - navigating to "http://localhost:3000/dashboard", waiting until "load"
    ...
    at /Users/stefanpalsson/parentload copy/parentload-clean/tests/e2e/complete-lifecycle/12-weekly-checkins.spec.js:44:16
```

# Test source

```ts
   1 | // tests/e2e/complete-lifecycle/12-weekly-checkins.spec.js
   2 | // 🎯 CRITICAL: Weekly Check-ins & Progress Tracking Tests
   3 | // "8-week transformation journey with personalized weekly goals"
   4 |
