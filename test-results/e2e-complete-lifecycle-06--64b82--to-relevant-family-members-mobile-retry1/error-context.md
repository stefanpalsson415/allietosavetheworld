...
- Name: 📄 CRITICAL: Document Hub & Email Integration >> 👨‍👩‍👧‍👦 Documents auto-link to relevant family members
- Location: /Users/stefanpalsson/parentload copy/parentload-clean/tests/e2e/complete-lifecycle/06-document-hub.spec.js:318:3
...
Call log:
  - navigating to "http://localhost:3000/dashboard?tab=documents", waiting until "load"
    ...
    at /Users/stefanpalsson/parentload copy/parentload-clean/tests/e2e/complete-lifecycle/06-document-hub.spec.js:322:16
```
