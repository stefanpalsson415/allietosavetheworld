...
- Name: 🧠 CRITICAL: Family Memory System >> 📸 Memory capture via photo upload
- Location: /Users/stefanpalsson/parentload copy/parentload-clean/tests/e2e/complete-lifecycle/11-family-memory.spec.js:95:3
...
Call log:
  - navigating to "http://localhost:3000/dashboard?tab=chat", waiting until "load"
    ...
    at /Users/stefanpalsson/parentload copy/parentload-clean/tests/e2e/complete-lifecycle/11-family-memory.spec.js:99:16
```
