...
- Name: 📊 CRITICAL: Weekly Check-ins & Progress Tracking >> 🌱 Sustainable habits formation tracking
- Location: /Users/stefanpalsson/parentload copy/parentload-clean/tests/e2e/complete-lifecycle/12-weekly-checkins.spec.js:236:3
...
Call log:
  - navigating to "http://localhost:3000/dashboard?tab=habits", waiting until "load"

    at /Users/stefanpalsson/parentload copy/parentload-clean/tests/e2e/complete-lifecycle/12-weekly-checkins.spec.js:240:16
```
