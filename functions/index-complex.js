...
app.post(['/', '/api/claude'], async (req, res) => {
  try {
    ...
    const claudeRequest = {
      model: model || 'claude-sonnet-4-20250514', // Updated to Claude Sonnet 4 with web search
...
// Import and export habit reminder functions
// Temporarily disabled due to deployment issues - will re-enable after fixing
// const { sendScheduledHabitReminders, scheduleHabitReminder } = require('./sendHabitReminders');
// exports.sendScheduledHabitReminders = sendScheduledHabitReminders;
// exports.scheduleHabitReminder = scheduleHabitReminder;