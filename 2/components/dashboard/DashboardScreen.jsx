...
import { LogOut, Filter, Settings, Users, Heart, Info, Calendar, Bell, MessageSquare, Clipboard, Award } from 'lucide-react';
...
const DashboardScreen = ({ onOpenFamilyMeeting }) => {
  ...
  useEffect(() => {
    ...
    if (tab && ['dashboard', 'tasks', 'relationship', 'children'].includes(tab)) {
      setActiveTab(tab);
    }
  }, [location]);
