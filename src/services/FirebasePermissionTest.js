  ...
  static async testPermissions(authContext = null) {
    ...
    try {
      ...
      try {
        ...
        const providerRef = await addDoc(collection(db, "familyProviders"), providerTest);
        ...
        // Test update permission
        await updateDoc(doc(db, "familyProviders", providerRef.id), {
          updated: true,
          updatedAt: serverTimestamp()
        });
        ...
        // Clean up test document
        await deleteDoc(doc(db, "familyProviders", providerRef.id));
