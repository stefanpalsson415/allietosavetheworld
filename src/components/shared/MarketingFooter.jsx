  ...
  const footerGroups = [
    {
      title: "Product",
      links: [
        { text: "Features Overview", path: "/" },
        { text: "How It Works", path: "/how-it-works" },
        { text: "Mini Assessment", path: "/survey/mini" },
        { text: "Pricing", path: "/payment" }
      ]
    },
    {
      title: "Company",
      links: [
        ...
        { text: "Blog", path: "/blog" },
        { text: "For Investors", path: "/investors" },
        { text: "Contact", path: "mailto:hello@allie.family" }
      ]
    },
    {
      title: "Get Started",
      links: [
        ...
        { text: "Free Trial", path: "/onboarding" }
      ]
    }
  ];
