...
import { Shield, DollarSign, TrendingUp, Users, Clock, Check } from 'lucide-react';
...
const BusinessCaseValidationSlide = () => {
  const validationPoints = [
    ...
    },
    {
      ...
      stats: '€740-920/mo nanny share',
      subStats: '€140/hr couples therapy',
      description: '€37/mo subscription looks cheap vs. real-world substitutes'
    },
    {
      id: 'global',
  ...
  const pricingData = [
    { name: 'Good Inside (Parent Coaching)', price: 23, note: 'Content only' },
    { name: 'Weekly Therapy Session', price: 140, note: 'Single hour' },
    { name: 'Nanny (1 day/week)', price: 185, note: 'Limited relief' },
    { name: 'Allie (€37/mo)', price: 37, note: 'Full family support' }
  ];
  ...
  return (
    <div className="min-h-[80vh] flex flex-col justify-center px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <h3 className="text-xl font-light text-gray-600 mb-8">Parents Will Pay €28-46/month for Comprehensive Family Support</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-purple-50 rounded-lg p-6 border border-purple-200">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  <div className="text-2xl font-bold text-purple-500 mr-3">€55k</div>
                  <p className="text-sm">Estimated annual value of the "invisible labor" parents perform; Allie at €444/year represents less than 1% of that value</p>
                </div>
              </div>
            </div>
