...
const TaskBoardTab = () => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm">
      ...
      {/* Information banner */}
      <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6 mx-6 flex items-start">
      ...
      {showTokens && (
        <div className="mb-6 mx-6 bg-white rounded-lg p-5 border border-yellow-200 shadow-sm">
      ...
      {/* Kanban board - full width, no padding */}
      <FamilyKanbanBoard hideHeader={false} />

      {/* Allie integration hint */}
      <div className="mt-8 mx-6 bg-gray-50 rounded-lg p-4">
      ...
      <div className="mt-4 mx-6 mb-6 bg-yellow-50 rounded-lg p-4">
